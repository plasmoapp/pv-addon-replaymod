...
import su.plo.voice.mod.client.audio.device.source.BaseAlSource;
import su.plo.voice.mod.client.audio.device.source.StreamAlSource;
...
public final class StreamAlLoopbackSource extends BaseAlSource {
    ...
    public static AlSource create(AlAudioDevice device, PlasmoVoiceClient client, boolean stereo, int numBuffers) {
        ...
        device.runInContext(() -> {
            ...
            AlSource source = new StreamAlLoopbackSource(client, device, stereo, numBuffers, pointer[0]);
    ...
    private StreamAlLoopbackSource(PlasmoVoiceClient client, AlAudioDevice device, boolean stereo, int numBuffers, int pointer) {
